...
class LoginController: UIViewController {
    ...
    func handleRegister() {
        ...
        FIRAuth.auth()?.createUser(withEmail: email, password: password, completion: { (user: FIRUser?, error) in
            ...
            let ref = FIRDatabase.database().reference(fromURL: "https://chatapp-322b6.firebaseio.com/")
    ...
    func setupInputsContainerView() {
        ...
        inputsContainerView.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 12).isActive = true
        inputsContainerView.widthAnchor.constraint(equalTo: view.widthAnchor, constant: -24).isActive = true
        inputsContainerViewHeightAncor = inputsContainerView.heightAnchor.constraint(equalToConstant: 150)
